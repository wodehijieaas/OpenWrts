...
it clone  https://github.com/destan19/OpenAppFilter package/otherapp/OpenAppFilter
git clone  https://github.com/zzsj0928/luci-app-pushbot package/otherapp/luci-app-pushbot
git clone  https://github.com/kkkidding/openwrt-qbittorrent.git package/otherapp/luci-app-qbittorrent
#git clone  https://github.com/kiddin9/openwrt-packages  package/otherapp/kiddin9
# vssr
